...
export async function proxy(request: NextRequest) {
  ...
  const publicApis = ["/api/verify-company", "/api/send-magic-link", "/api/send-reset-password", "/api/admin/repas-photo", "/api/chat/send", "/api/profil/poids", "/api/cron/daily-email"]
